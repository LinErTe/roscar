...
inline void InitDefaults() {
  ...
  InitDefaultsTrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D();
...
class TrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.TrajectoryBuilderOptions.OverlappingSubmapsTrimmerOptions2D) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto::TableStruct;
  friend void ::protobuf_cartographer_2fmapping_2fproto_2ftrajectory_5fbuilder_5foptions_2eproto::InitDefaultsTrajectoryBuilderOptions_OverlappingSubmapsTrimmerOptions2DImpl();
};
// -------------------------------------------------------------------
