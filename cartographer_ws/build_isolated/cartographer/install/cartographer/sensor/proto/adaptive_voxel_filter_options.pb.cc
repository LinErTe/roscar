...
void InitDefaultsAdaptiveVoxelFilterOptions() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsAdaptiveVoxelFilterOptionsImpl);
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::sensor::proto::AdaptiveVoxelFilterOptions, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::sensor::proto::AdaptiveVoxelFilterOptions, max_length_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::sensor::proto::AdaptiveVoxelFilterOptions, min_num_points_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::sensor::proto::AdaptiveVoxelFilterOptions, max_range_),
};
