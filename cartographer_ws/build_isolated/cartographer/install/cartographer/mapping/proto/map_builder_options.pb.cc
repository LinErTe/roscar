...
void InitDefaultsMapBuilderOptions() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsMapBuilderOptionsImpl);
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::proto::MapBuilderOptions, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::proto::MapBuilderOptions, use_trajectory_builder_2d_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::proto::MapBuilderOptions, use_trajectory_builder_3d_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::proto::MapBuilderOptions, num_background_threads_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::proto::MapBuilderOptions, pose_graph_options_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::cartographer::mapping::proto::MapBuilderOptions, collate_by_trajectory_),
};
...
void AddDescriptorsImpl() {
  ...
  ::protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_5foptions_2eproto::AddDescriptors();
}
